...
let imageScale = 1; // Default scale for the uploaded image
const scaleStep = 0.1; // Step for zooming in/out
...
function resizeAndFitImage(img) {
  ...
  if (imgAspect > canvasAspect) {
    ...
    height = (canvas.width / imgAspect) * imageScale;
  } else {
    height = canvas.height * imageScale;
    width = (canvas.height * imgAspect) * imageScale;
  }
